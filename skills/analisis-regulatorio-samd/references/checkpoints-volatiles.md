...
| 7 | Usa IA/ML | **Estándares armonizados de IA** (CEN-CENELEC JTC 21) y **ley nacional española de IA** (autoridades competentes, régimen sancionador, etiquetado de contenido IA) | `AI Act harmonised standards JTC 21 status` + `anteproyecto ley buen uso gobernanza inteligencia artificial España BOE régimen sancionador` | Estándares en desarrollo; su disponibilidad condiciona la exigibilidad efectiva. Anteproyecto de Ley para el buen uso y la gobernanza de la IA aprobado en Consejo de Ministros 11-mar-2025 (1ª vuelta); en tramitación, **no publicado en BOE** a la fecha de referencia. Cuantías del art. 99 del Reglamento aplicables desde 2-ago-2026. Para SaMD con IA, la vigilancia del mercado recae en **AEMPS** (art. 74.3), no en AESIA. |
